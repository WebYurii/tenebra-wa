...
/**
 * Baileys ждёт `oldestMsgTimestampMs` в МИЛЛИСЕКУНДАХ, а время сообщений и
 * в CRM, и в самих WAMessage лежит в секундах. На секундах телефон просто
 * молчит: ни ошибки, ни события истории — поэтому нормализуем на входе.
...
module.exports = { pickHistoryMedia, toMillis };
